 ...
 * @LastEditTime: 2022-01-25 13:58:25
...
const SelfPrivacy: React.FC<IPageStateProps> = () => {
  return (
    <>
      <CommonHeader title='隐私指引' left fixed to={2}></CommonHeader>
      <View className='vi-selfprivacy-warpper'>
        ...
        <p>【特别提示】 为方便您理解和阅读本指引，我们试图采用简洁明了的语言向您呈现本指引的各项内容。</p>
        <p>
        ...
        <ul className='item'>
          <li> 一 运营者基本情况</li>
          <li> 二 适用范围</li>
          <li> 三 我们如何收集和使用您的个人信息</li>
          <li> 四 我们如何共享、公开披露您的个人信息</li>
          <li> 五 我们如何保护您的个人信息</li>
          <li> 六 您管理个人信息的权利</li>
          <li>七 您个人信息的存储</li>
          <li>八 我们如何使用 Cookie 和其他追踪技术</li>
          <li>九 我们服务的对象及未成年人保护措施</li>
          <li>十 如何更新与修改本指引</li>
          <li> 十一 争议解决</li>
        </ul>
        <p>第一条 运营者基本情况</p>
        ...
        <p>第二条 适用范围</p>
        <p className='desc'>本指引适用于楚日历提供的所有服务，您使用楚日历提供的服务，均适用本指引。</p>
        <p>第三条 我们如何收集和使用您的个人信息</p>
        <p className='desc'>
          我们会遵循正当、合法、必要的原则，出于本指引所述的以下目的，收集和使用您在使用服务过程中主动提供、因使用楚日历产品和/或服务而产生的个人信息、或经您授权向第三方合法持有您信息的数据机构收集您的个人信息。如果我们要将您的个人信息用于本指引未载明的其它用途，或基于特定目的将收集而来的信息用于其他目的，我们将以合理的方式向您告知，并在使用前再次征得您的同意。
        </p>
        <p className='desc'>
          3.1 注册及登录楚日历账户
        ...
        <p className='desc'>
          3.3 在您使用服务过程中收集的信息 为了向您提供更优质的产品和服务，我们可能需要收集下述信息:
          （一）楚日历平台会收集您在使用楚日历平台过程中产生的保单信息用于向您展示及便于您对保单进行管理。
          <br></br>
          （二）定向推送
        ...
        <p>
          3.4 敏感信息 在向楚日历提供任何属于敏感信息的个人信息前，请您清楚考虑该等提供是恰当的并且同意您的个人敏感信息可按本指引所述的目的和方式进行处理。
          我们会在得到您的同意后收集和使用您的敏感信息以实现与楚日历业务相关的功能。
        </p>
        <p>第四条 我们如何共享、公开披露您的个人信息：</p>
        <p>
          4.1 共享您的个人信息 我们不会与任何公司、组织和个人共享您的个人信息，但以下情况除外：
          <br></br>
          1、为向您提供电商网络技术支持辅助服务；
          <br></br>
          ...
          <br></br>
          4、在法律要求或允许的范围内，为了保护楚日历平台及其用户或社会公众的利益、财产或安全免遭损害而有必要提供您的个人信息给第三方；
          <br></br>
          5、与我们的关联公司共享：您的个人信息可能会在我们的关联公司之间共享。我们只会共享必要的个人信息，且这种共享受本指引所声明目的的约束。关联公司如要改变个人信息的处理目的，将再次征求您的授权同意；
          <br></br>
          6、与授权合作伙伴共享：为了向您提供更完善、优质的产品和服务，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。同时，我们会与合作伙伴签署严格的保密协定，要求他们按照我们的说明、本指引以及其他任何相关的保密和安全措施来处理您的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。如果您拒绝我们的合作伙伴在提供服务时收集为提供服务所必须的个人信息，将可能导致您无法在楚日历中使用该第三方服务。
        </p>
        <p>
          4.2 转让 除非获取您的明确同意，我们不会将您的个人信息转让给任何公司、组织或个人，但以下情形除外：
          <br></br>
          1、
          如果发生合并、收购或破产清算，将可能涉及到个人信息转让，此种情况下我们会要求新的持有您个人信息的公司、组织继续受本指引的约束。如果本指引中约定的个人信息的收集、处理方式发生任何改变，该公司、组织将重新向您征求授权同意；
          <br></br>
          2、 在获取明确同意的情况下转让：获得您的明确同意后，楚日历可向其他方转让您的个人信息。
        </p>
        <p>4.3 公开披露 我们不会与任何公司、组织和个人公开披露您的个人信息，但以下情况除外：</p>
        <p className='desc'>
          1、事先获得您的明确授权或同意；
          <br></br>
        ...
        <p>6.1 访问和更正您的个人信息 除法律法规规定外，您有权随时访问、更正您的个人信息。</p>
        <p>
          6.2 改变您授权同意的范围
        ...
        <p>
          6.4 响应您的上述请求 为保障安全，我们可能会先要求您验证自己的身份，然后再处理您的请求。您可能需要提供书面请求，或以其他方式证明您的身份。
        ...
        <p>第八条 我们服务的对象及未成年人保护措施</p>
        <p>
          8.1
          我们重视未成年人的信息保护。如您为未成年人，您务必请您的父母或监护人仔细阅读本隐私声明，并在征得您父母或监护人同意的前提下才能向我们提供信息、使用楚日历平台的服务或购买相关商品、参与抽奖等。
        </p>
        <p>8.2 受限于信息技术，在注册成为楚日历用户时，我们可能无法核验您的年龄或身份，如您不慎注册了楚日历，请您及时联系我们删除您的相关数据信息。</p>
        <p>
          8.3
        ...
        <p>第十条 争议解决</p>
        <p>10.1. 因本指引以及我们处理您个人信息事宜引起的任何争议，您可诉至本协议签订地【宁夏回族自治区吴忠市利通区】有管辖权的人民法院。</p>
        <p>10.2 如果您认为我们的个人信息处理行为损害了您的合法权益，您也可向有关政府部门进行反映。</p>
      </View>
    </>
  )
}
