 ...
 * @LastEditTime: 2022-01-26 11:22:58
        ...
        <View className='preface'>
          ...
          <View className='catalogue'>
            ...
            <View className='item'>
              ...
              <p className='section'>本指引适用于楚日历提供的所有服务，您使用楚日历提供的服务，均适用本指引。</p>
            </View>
            <View className='item'>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>（一）楚日历平台会收集您在使用楚日历平台过程中产生的保单信息用于向您展示及便于您对保单进行管理。</li>
                    <li>
                      （二）定向推送
                      <View>
            ...
            <View className='item'>
              ...
              <ul>
                <li>
                  ...
                  <ol>
                    <li>为向您提供电商网络技术支持辅助服务；</li>
                    <li>事先获得您的明确授权或同意：获得您的明确同意后，我们会与其他方共享您的个人信息；</li>
                    <li>在法定情形下的共享：根据适用的法律法规、法律程序、政府的强制命令或司法裁定而需共享您的个人信息；</li>
                    <li>在法律要求或允许的范围内，为了保护楚日历平台及其用户或社会公众的利益、财产或安全免遭损害而有必要提供您的个人信息给第三方；</li>
                    <li>
                      与我们的关联公司共享：您的个人信息可能会在我们的关联公司之间共享。我们只会共享必要的个人信息，且这种共享受本指引所声明目的的约束。关联公司如要改变个人信息的处理目的，将再次征求您的授权同意；
                    </li>
                    <li>
                      与授权合作伙伴共享：为了向您提供更完善、优质的产品和服务，我们的某些服务将由授权合作伙伴提供。我们可能会与合作伙伴共享您的某些个人信息，以提供更好的客户服务和用户体验。我们仅会出于合法、正当、必要、特定、明确的目的共享您的个人信息，并且只会共享提供服务所必要的个人信息。同时，我们会与合作伙伴签署严格的保密协定，要求他们按照我们的说明、本指引以及其他任何相关的保密和安全措施来处理您的个人信息。我们的合作伙伴无权将共享的个人信息用于任何其他用途。如果您拒绝我们的合作伙伴在提供服务时收集为提供服务所必须的个人信息，将可能导致您无法在楚日历中使用该第三方服务。
                    </li>
                  </ol>
                </li>
                <li>
                  ...
                  <ol>
                    ...
                    <li>在获取明确同意的情况下转让：获得您的明确同意后，楚日历可向其他方转让您的个人信息。</li>
                  </ol>
                </li>
                <li>
                  4.3 公开披露 我们不会与任何公司、组织和个人公开披露您的个人信息，但以下情况除外：
                  <ol>
                    <li>事先获得您的明确授权或同意；</li>
                    <li>
            ...
            <View className='item'>
              ...
              <ul>
                <li>
                  <ol>
                    <li>访问和更正您的个人信息 除法律法规规定外，您有权随时访问、更正您的个人信息。</li>
                    <li>
                      改变您授权同意的范围
                      <br></br>
            ...
            <View className='item'>
              ...
              <p>我们仅在本隐私条款所述目的所必需的期间和法律法规要求的最短时限内保留您的个人信息，对于超出期限的个人信息，我们会立即删除或做匿名化处理。</p>
              <p>
            ...
            <View className='item'>
              ...
              <ul>
                <li>
                  <ol>
                    <li>因本指引以及我们处理您个人信息事宜引起的任何争议，您可诉至本协议签订地【宁夏回族自治区吴忠市利通区】有管辖权的人民法院。</li>
